...
> Upload from: `docs/architecture/diagram_a_the_fleet.png`
> Or drag from: https://raw.githubusercontent.com/Jeremiah-Sakuda/Hodi/main/docs/architecture/diagram_a_the_fleet.png
> Suggested caption: *The conflict-of-interest topology. The walls are the product.*
...
> Upload from: `docs/architecture/diagram_b_what_hodi_will_not_say.png`
> Or drag from: https://raw.githubusercontent.com/Jeremiah-Sakuda/Hodi/main/docs/architecture/diagram_b_what_hodi_will_not_say.png
> Suggested caption: *The fifth column is the one that matters. There is no enum value for it, so the schema cannot express the claim.*
