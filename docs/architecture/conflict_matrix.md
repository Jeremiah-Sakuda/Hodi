...
| **Licensing Negotiator** | `licensing-negotiator-sa@hodi-2026.iam.gserviceaccount.com` | `buyer_terms` | `buyer_terms/{counterparty_id}`<br>`receipts` | `artists`<br>`works`<br>`crawler_access`<br>`canaries`<br>`revocation_notices` |
