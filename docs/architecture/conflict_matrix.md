...
| **Evidence Agent** | `evidence-agent-sa@hodi-2026.iam.gserviceaccount.com` | `evidence` | `crawler_access`<br>`canaries`<br>`evidence_records` | `artists`<br>`buyer_terms`<br>`grants`<br>`revocation_notices`<br>`revocation_outbox` |
